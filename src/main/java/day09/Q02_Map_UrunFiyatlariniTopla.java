...
public class Q02_Map_UrunFiyatlariniTopla {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(fiyatToplami(urunFiyati));//184.95
    }

    public static double fiyatToplami(Map<String , Double> map) {
        System.out.println("Urunler ve fiyatlari :" + map);//Urunler ve fiyatlari :{Kemer=19.99, Kazak=24.99, Kravat=19.99, Ayakkabi=89.99, Gomlek=29.99}
